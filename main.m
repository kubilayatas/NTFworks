...
rng(25);
load D:/Users/kuatas/Desktop/HyperSpectralWorks/datasets/sim2_50DB/sim_im.mat;
load D:/Users/kuatas/Desktop/HyperSpectralWorks/datasets/sim2_50DB/sim_abun.mat;
load D:/Users/kuatas/Desktop/HyperSpectralWorks/datasets/sim2_50DB/endm.mat;
load D:/Users/kuatas/Desktop/HyperSpectralWorks/datasets/sim2_50DB/dsm.mat;

realEndmember=endm;
%realAbundance=sim_abun;
[tensorData realAbundance] = cut_HSI_data(sim_im,sim_abun,61:124,1:64);  %49x49 61:109,1:49 %64x64 61:124,1:64 % 81x81 61:141,1:81
LidarData = dsm(61:124,1:64);
EndNum=5;
%rankNumber=173;
...
SlidingWindow_LidarCoeff_5x5 = SlidingWindowWeights(tensorData, LidarData,[5 5]);
save('SlidingWindow_LidarCoeff_5x5.mat',SlidingWindow_LidarCoeff_5x5);
...
try
    load D:/Users/kuatas/Desktop/HyperSpectralWorks/LidarlýSlidingWindowKüçükVeri-RandomInit/sonuclar.mat
catch
...
tic;
[A,B,C,U,V,E]= mvntfTV(tensorData,bt_A,bt_B,bt_C,lambda,mu,EndNum,rankNumber,SlidingWindow_LidarCoeff_5x5);
sure = toc;
